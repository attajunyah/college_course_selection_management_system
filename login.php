...
if($_POST){
    $username   = mysqli_real_escape_string($conn,trim($_POST['studentName']));
	$password   = md5(mysqli_real_escape_string($conn,trim($_POST['studentPassword'])));
	
	echo studentLogin($username,$password);
}
?>
<style>
@import "bourbon";
...
<div class="container">
  <div class="wrapper">
    <form class="form-signin" method="post" action="login.php">       
      ...
      <input type="text" class="form-control" name="studentName" placeholder="Username" required="" autofocus="" />
